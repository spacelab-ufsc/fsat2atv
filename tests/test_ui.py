...
def test_ui():
    builder = Gtk.Builder()
    builder.add_from_file("fsat2atv/data/ui/fsat2atv.glade")
    ...
    label_obdh_mem_sec_payload          = builder.get_object("label_obdh_mem_sec_payload")
    ...
    label_lora_fsat2a_ts                = builder.get_object("label_lora_fsat2a_ts")
    label_lora_fsat2a_id                = builder.get_object("label_lora_fsat2a_id")
    label_lora_fsat2a_pkt_cnt           = builder.get_object("label_lora_fsat2a_pkt_cnt")
    label_lora_fsat2a_temp              = builder.get_object("label_lora_fsat2a_temp")
    label_lora_fsat2a_rssi              = builder.get_object("label_lora_fsat2a_rssi")
    label_lora_fsat2a_snr               = builder.get_object("label_lora_fsat2a_snr")
    label_lora_fsat2a_freq_err          = builder.get_object("label_lora_fsat2a_freq_err")

    label_lora_fsat2b_ts                = builder.get_object("label_lora_fsat2b_ts")
    label_lora_fsat2b_id                = builder.get_object("label_lora_fsat2b_id")
    label_lora_fsat2b_pkt_cnt           = builder.get_object("label_lora_fsat2b_pkt_cnt")
    label_lora_fsat2b_temp              = builder.get_object("label_lora_fsat2b_temp")
    label_lora_fsat2b_rssi              = builder.get_object("label_lora_fsat2b_rssi")
    label_lora_fsat2b_snr               = builder.get_object("label_lora_fsat2b_snr")
    label_lora_fsat2b_freq_err          = builder.get_object("label_lora_fsat2b_freq_err")
    label_lora_fsat2b_bat_volt          = builder.get_object("label_lora_fsat2b_bat_volt")
    ...
    assert label_obdh_mem_sec_payload           != None
    ...
    assert label_lora_fsat2a_ts                 != None
    assert label_lora_fsat2a_id                 != None
    assert label_lora_fsat2a_pkt_cnt            != None
    assert label_lora_fsat2a_temp               != None
    assert label_lora_fsat2a_rssi               != None
    assert label_lora_fsat2a_snr                != None
    assert label_lora_fsat2a_freq_err           != None
    assert label_lora_fsat2b_ts                 != None
    assert label_lora_fsat2b_id                 != None
    assert label_lora_fsat2b_pkt_cnt            != None
    assert label_lora_fsat2b_temp               != None
    assert label_lora_fsat2b_rssi               != None
    assert label_lora_fsat2b_snr                != None
    assert label_lora_fsat2b_freq_err           != None
    assert label_lora_fsat2b_bat_volt           != None
